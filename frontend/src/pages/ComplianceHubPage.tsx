...
import { UploadCloud, ShieldCheck, FileText, Download, Eye, Zap, Activity } from 'lucide-react';
...
export const ComplianceHubPage: React.FC<ComplianceHubProps> = ({ session, profile, apiUrl }) => {
    // Audit state
